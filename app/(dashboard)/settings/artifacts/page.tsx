...
export default async function ArtifactsSettingsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <nav className="flex items-center gap-1 text-sm text-gray-500 mb-6">
        ...
        <span className="text-gray-900 font-medium">Access Control Artifacts</span>
      </nav>

      <div className="flex items-center justify-between mb-6">
        <h1 className="text-xl font-bold text-gray-900">Access Control Artifacts</h1>
