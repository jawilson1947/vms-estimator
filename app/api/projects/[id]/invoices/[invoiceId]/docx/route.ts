...
// POST /api/projects/[id]/invoices/[invoiceId]/docx
export async function POST(
  ...
  const buf     = await generateInvoiceDocx(docData, companyFromSettings(userSettings));
  ...
  return new NextResponse(buf as unknown as BodyInit, {
    ...
    headers: {
      ...
      'Content-Disposition': `attachment; filename="invoice-${slug}-${invoice.invoiceNumber}.docx"`,
    },
  });
}
